...
void HUD::drawIntroText() {
	...
	printText(0.50, 2.1, "You begin your journey in the Garden of the Blind", 0.8, 0.8, 0.8);
...
void HUD::drawHUD() { //draws a 2D overlay
	...
	printText(0.22, hudTextY, zenStr, 0.6, 0.2, 0.2);	//print amount of Zen
	printText(0.37, hudTextY, "%", 0.1, 0.1, 0.1);	//print Zen label
	printText(0.94, hudTextY, "SphereQuest 1.5", 0.8, 0.3, 0.3);	//print Title
...
void HUD::beginHudDrawing() {	//sets up OpenGL for drawing 2d overlay stuff. Always call this before drawing HUD stuff.
	...
	glLoadIdentity();
	gluOrtho2D(0.0, 3.0, 3.0, 0.0);		//set ortho mode
